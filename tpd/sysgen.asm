; Disassembly of SYSGEN.COM from tpd801.td0
...
bsectrn	equ	45
	...
	db	' '
	db	'Revised September 13 1984 APP-ICE '

systrk:	db	2	; number of system tracks
spt:	db	16*4	; 16 spt at 512b
secoff:	db	0	; sector number offset
...
dstdrv:	db		'M, THEN TYPE RETURN',0
...
stack:	ds	0
	...
	; ghosts from assembler... kept so binaries match
	db	'E',0
