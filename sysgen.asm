...
;	         1976, 1977, 1978, 1979
;
;	Modifications Mar 31 2021:
;	- adapted for Junior-80 5.25" 80-track drives,
;	  based on SYSGEN.COM for Junior 8" single-density
;	Douglas Miller <durgadas311@gmail.com>
;
SECSIZ	EQU	128	;CP/M LOGICAL SECTOR SIZE
PSCSIZ	EQU	512	;SIZE OF EACH PHYSICAL SECTOR
NSECTS	EQU	9*(PSCSIZ/SECSIZ)	;NO. OF SECTORS PER TRACK
...
STRNF	EQU	45	;WBOOT+45 FOR SEC TRANS FUNCTION
;
	ORG	TPA	;TRANSIENT PROGRAM AREA
	JMP	START
	DB	'COPYRIGHT (C) 1978, DIGITAL RESEARCH '
	DB	'Junior-80 Mar 31 2021 DRM '
;
;	SECTOR NUMBERS ARE TRANSLATED BY BIOS
;
...
READ:	;PERFORM READ OPERATION
	...
	PCHL
;
WRDEF1:	MVI	C,2	; DEFERRED WRITE CODE
WRITE:	;PERFORM WRITE OPERATON
	...
	PCHL
;
SECTRN:	;PERFORM BIOS SECTOR TRANSLATION
	LHLD	WBOOT
	PUSH	D
	LXI	D,STRNF
	DAD	D
...
;	READ OR WRITE SECTOR TO OR FROM CURRENT DMA ADDR
	...
	XCHG
	CALL	SECTRN
	MOV	C,L	;VALUE TO C READY FOR SELECT
...
ENDRW:	;END OF READ OR WRITE, RETURN TO CALLER
	MVI	C,1	;NON-DEFERRED WRITE - FLUSH BUFFER
	JMP	WRITE
;
;
START:
...
SECTBL:	DS	2	;SECTOR TRANSLATION TABLE
